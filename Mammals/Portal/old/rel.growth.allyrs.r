...
relE.con=relE.con[which(controls[,1]!=lastyear),]
...
con.r=con.r[which(controls[,1]!=lastyear),] 
...
relE.ex=relE.ex[which(exclosures[,1]!=lastyear),]
...
ex.r=ex.r[which(exclosures[,1]!=lastyear),]     
