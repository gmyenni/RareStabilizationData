...
#data: 5pgrass
abund=read.table("5pgrass.txt",header=T)
energy=read.table("5pgrass_E.txt",header=T)
lastyear=2005
...
plot(relE[,1],rates[,5],xlim=c(0,1),ylim=c(-3,3),main="5pgrass",xlab="relative E",ylab="log lambda")
